...
public interface RegistrationRepository extends JpaRepository<Registration, Long> {
    ...
    long countByLecturerIdAndGraduationTermIdAndStatus(Long lecturerId, Long graduationTermId, RegistrationStatus status);

    List<Registration> findByLecturerIdAndGraduationTermIdAndStatusOrderByIdDesc(Long lecturerId, Long graduationTermId, RegistrationStatus status);
