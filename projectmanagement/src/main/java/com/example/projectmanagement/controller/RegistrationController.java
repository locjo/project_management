...
public class RegistrationController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<RegistrationResponse>> registerTopic(
            Authentication authentication,
            @Valid @RequestBody RegisterTopicRequest request) {

        RegistrationResponse data = registrationService.registerTopic(authentication.getName(), request);
